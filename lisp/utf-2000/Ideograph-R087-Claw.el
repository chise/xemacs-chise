...
(define-char
  '((<-denotational
    ...
    (shinjigen-1	.  4701)	; &GT-25242;
    (shinjigen-2	.  4701)	; &GT-25242;
...
(define-char
  '((<-denotational
    ...
    (shinjigen-1	.  4703)	; &GT-25270;
    (shinjigen-2	.  4703)	; &GT-25270;
...
(define-char
  '((<-denotational
    ...
    (->subsumptive
     ((=gt		  . 25312)	; &GT-25312;
      (=gt-pj-9		  . #x663F)	; &GT-25312; [70-31]
      (=ucs@iso		  . #x24532)	; &GT-25312;
      )
     ((=cns11643-4	  . #x5665)	; &C4-5665; [54-69]
      ))
    ))
(define-char
  '((ideographic-radical . 87)	; ⽖
