...
(define-char
  '((<-denotational
    ...
    (->subsumptive
     ((==ucs@jis/1990	  . #x9F9C)	; &g2-J90-737D;
      (==ucs@jis/2000	  . #x9F9C)	; &g2-J90-737D;
      (==ucs@jis/2004	  . #x9F9C)	; &g2-J90-737D;
  ...
  '((<-denotational
	...
	(=shinjigen@rev	    .  9917)	; &GT-66712;
      ...
      (->subsumptive
       ...
       ((==cns11643-7	    . #x2C3A)	; &g2-C7-2C3A; [12-26]
	))
      ))
    ))
(define-char
...
(define-char
  '((ideographic-radical . 213)	; ⿔
    ...
    (=ucs		. #x2A6B1)	; 𪚱
    (->subsumptive
     ((=daikanwa	  . 48861)	; &M-48861;
      )
     ((=ucs@iso		  . #x2A6B1)	; &C7-5273;
      (=cns11643-7	  . #x5273)	; &C7-5273; [50-83]
      ))
    ))
(define-char
  '((ideographic-radical . 213)	; ⿔
...
(define-char
  '((<-denotational
    ...
    (<-ancient*sources
     zihui daikanwa)
    (->subsumptive
     ((==jis-x0208@1978	  . #x6354)	; &g2-M-48869; [67-52]
      (==daikanwa	  . 48869)	; &g2-M-48869;
      (->subsumptive
       ((===daikanwa	    . 48869)	; &R-M-48869;
	)
...
(define-char
  '((<-denotational
    ...
    (->subsumptive
     ...
     ((==ucs@jis	  . #x9F9E)	; &g2-JSP-6D5F;
      (==jis-x0212	  . #x6D5F)	; &g2-JSP-6D5F; [77-63]
      ))
    ))
(define-char
  '((<-denotational
