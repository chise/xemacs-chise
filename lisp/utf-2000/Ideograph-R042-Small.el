...
(define-char
  '((<-denotational
    ...
    (->subsumptive
     ...
     ((shinjigen-1	  .  4715)	; &MCS-000F03CE;
      (shinjigen-2	  .  4715)	; &MCS-000F03CE;
      )
...
(define-char
  '((ideographic-radical . 42)	; ⼩
    ...
    (total-strokes	 . 9)
    (=ucs		. #x5C1D)	; 尝
    (=gb2312		. #x3322)	; &I-G0-3322; [19-02]
    (=hanziku-2		. #xC3EB)	; &I-HZK02-C3EB;
    ))
(define-char
  '((ideographic-radical . 42)	; ⼩
...
(define-char
  '((=>ucs		. #x3779)	; 㝹
    ...
    (ideographic-strokes . 8)
    (total-strokes	 . 11)
    (=cns11643-6	. #x3E64)	; &CB00144; [30-68]
...
(define-char
  '((ideographic-radical . 42)	; ⼩
    ...
    (=jis-x0213-1-2000	. #x4F5C)	; &I-JX1-4F5C; [47-60]
...
(define-char
  '((ideographic-radical . 42)	; ⼩
    ...
    (=big5		. #xDD4B)	; &I-B-DD4B;
    (->subsumptive
     ((=jis-x0212	  . #x3A6C)	; &M-07522; [26-76]
      (=daikanwa	  . 07522)	; &I-M-07522;
      (=ucs@jis		  . #x5C1F)	; &M-07522;
      )
     ((=cns11643-2	  . #x4251)	; &C2-4251; [34-49]
      (=ucs@unicode	  . #x5C1F)	; &C2-4251;
      ))
    ))
(define-char
  '((=>ucs		. #x5C20)	; 尠
