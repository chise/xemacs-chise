...
(define-char
  '((ideographic-radical . 11)	; ⼊
    ...
    (=ucs		. #x204F1)	; 𠓱
    (=cns11643-6	. #x3D3A)	; &I-C6-3D3A; [29-26]
    (=daikanwa		. 01442)	; &I-M-01442;
    (=hanziku-1		. #xCCB7)	; &I-HZK01-CCB7;
    (<-ancient
...
(define-char
  '((ideographic-radical . 11)	; ⼊
	...
	(=daikanwa	    . 00154)	; &I-M-00154;
     ...
     ((=ucs@iso		  . #x204F8)	; &U-000204F8;
      )
     ((=cns11643-6	  . #x5A78)	; &C6-5A78; [58-88]
      ))
    ))
(define-char
  '((ideographic-radical . 11)	; ⼊
