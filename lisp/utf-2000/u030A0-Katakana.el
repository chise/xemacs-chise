...
(define-char
  '((name		. "KATAKANA-HIRAGANA DOUBLE HYPHEN")
    (=ucs		. #x30A0)	; ゠
    (=jis-x0213-1	. #x237B)	; &I-JX1-237B; [03-91]
    ))
(define-char
...
(define-char
  '((name		. "KATAKANA LETTER VA")
    ...
    (=ucs		. #x30F7)	; ヷ
    (=jis-x0213-1	. #x2772)	; &I-JX1-2772; [07-82]
    ))
(define-char
  '((name		. "KATAKANA LETTER VI")
    ...
    (=ucs		. #x30F8)	; ヸ
    (=jis-x0213-1	. #x2773)	; &I-JX1-2773; [07-83]
    ))
(define-char
  '((name		. "KATAKANA LETTER VE")
    ...
    (=ucs		. #x30F9)	; ヹ
    (=jis-x0213-1	. #x2774)	; &I-JX1-2774; [07-84]
    ))
(define-char
  '((name		. "KATAKANA LETTER VO")
    ...
    (=ucs		. #x30FA)	; ヺ
    (=jis-x0213-1	. #x2775)	; &I-JX1-2775; [07-85]
    ))
(define-char
  '((name		. "KATAKANA MIDDLE DOT")
    ...
    (=jis-x0213-1	. #x2126)	; &I-JX1-2126; [01-06]
    ))
(define-char
