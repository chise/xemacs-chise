...
(define-char
  '((shuowen-radical	. 24)	; 吅
    (=shuowen-jiguge	. 04402)	; &SW-JIGUGE-04402;
    (<-Small-Seal@shuowen
     ((=ucs		  . #x5405)	; 吅
      )
...
(define-char
  '((shuowen-radical	. 24)	; 吅
    (=shuowen-jiguge	. 04403)	; &SW-JIGUGE-04403;
    (<-Small-Seal@shuowen
     ((=ucs		  . #x24566)	; 𤕦
      ))
    (->subsumptive
...
(define-char
  '((shuowen-radical	. 24)	; 吅
    (=shuowen-jiguge	. 04404)	; &SW-JIGUGE-04404;
    (<-Small-Seal@shuowen
     ((=ucs		  . #x24567)	; 𤕧
      ))
    (->subsumptive
...
(define-char
  '((shuowen-radical	. 24)	; 吅
    (=shuowen-jiguge	. 04405)	; &SW-JIGUGE-04405;
    (<-Small-Seal@shuowen
     ((=ucs		  . #x56B4)	; 嚴
      )
     ((=ucs		  . #x53B3)	; 厳
...
(define-char
  '((shuowen-radical	. 24)	; 吅
    (=shuowen-jiguge	. 04406)	; &SW-JIGUGE-04406;
    (<-Small-Seal@shuowen
     ((=ucs		  . #x2116E)	; 𡅮
      ))
    (->subsumptive
...
(define-char
  '((shuowen-radical	. 24)	; 吅
    (=shuowen-jiguge	. 04407)	; &SW-JIGUGE-04407;
    (<-Small-Seal@shuowen
     ((=ucs		  . #x35BE)	; 㖾
      )
     ((=ucs		  . #x54A2)	; 咢
...
(define-char
  '((shuowen-radical	. 24)	; 吅
    (=shuowen-jiguge	. 04409)	; &SW-JIGUGE-04409;
    (<-Small-Seal@shuowen
     ((=ucs		  . #x558C)	; 喌
      ))
    (->subsumptive
