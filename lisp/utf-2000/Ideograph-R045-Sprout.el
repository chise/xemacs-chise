...
(define-char
  '((<-denotational
    ...
    (=jis-x0213-1-2000	. #x4F62)	; &I-JX1-4F62; [47-66]
    (=big5		. #xC94B)	; &I-B-C94B;
  ...
  '((ideographic-radical . 45)	; ⼬
    ...
    (->subsumptive
     ((=jis-x0208	  . #x4656)	; &GT-09854; [38-54]
      ...
      (=shinjigen@1ed	  .  1953)	; &GT-09854;
      (=shinjigen@rev	  .  1953)	; &GT-09854;
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 4)
    (=ucs		. #x37A2)	; 㞢
    (=cns11643-3	. #x2162)	; &I-C3-2162; [01-66]
    (=daikanwa		. 07829)	; &I-M-07829;
    (=hanziku-3		. #xD0A8)	; &I-HZK03-D0A8;
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (=jis-x0213-2-2000	. #x2836)	; &I-JX2-2836; [08-22]
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 6)
    (=ucs		. #x21D01)	; 𡴁
    (=cns11643-6	. #x2454)	; &I-C6-2454; [04-52]
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 6)
    (=ucs		. #x21D05)	; 𡴅
    (=cns11643-5	. #x224F)	; &I-C5-224F; [02-47]
...
(define-char
  '((morohashi-daikanwa	7839 0 0)
    ...
    (total-strokes	 . 7)
    (=ucs		. #x21D06)	; 𡴆
    (=cns11643-4	. #x2375)	; &I-C4-2375; [03-85]
    ))
(define-char
  '((ideographic-radical . 45)	; ⼬
    (ideographic-strokes . 4)
...
(define-char
  '((=>ucs		. #x21D08)	; 𡴈
    ...
    (ideographic-strokes . 4)
    (total-strokes	 . 7)
    (=cns11643-6	. #x272A)	; &M-07841; [07-10]
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 8)
    (=ucs		. #x21D0C)	; 𡴌
    (=cns11643-6	. #x2A71)	; &I-C6-2A71; [10-81]
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 8)
    (=ucs		. #x21D0D)	; 𡴍
    (=cns11643-6	. #x2A70)	; &I-C6-2A70; [10-80]
...
(define-char
  '((morohashi-daikanwa	7849 0 4)
    ...
    (total-strokes	 . 9)
    (=ucs		. #x21D12)	; 𡴒
    (=cns11643-5	. #x2876)	; &I-C5-2876; [08-86]
    ))
(define-char
  '((ideographic-radical . 45)	; ⼬
    (ideographic-strokes . 6)
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 10)
    (=ucs		. #x21D17)	; 𡴗
    (=cns11643-6	. #x3676)	; &I-C6-3676; [22-86]
...
(define-char
  '((=>ucs		. #x21D1B)	; 𡴛
    ...
    (total-strokes	 . 11)
    (=cns11643-6	. #x3E71)	; &M-07854; [30-81]
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 11)
    (=ucs		. #x21D1C)	; 𡴜
    (=cns11643-6	. #x3E72)	; &I-C6-3E72; [30-82]
...
(define-char
  '((morohashi-daikanwa	7857 0 0)
    ...
    (total-strokes	 . 12)
    (=ucs		. #x21D1E)	; 𡴞
    (=cns11643-5	. #x3767)	; &I-C5-3767; [23-71]
    ))
(define-char
  '((=>ucs		. #x21D1F)	; 𡴟
    (ideographic-radical . 45)	; ⼬
    (ideographic-strokes . 9)
    (total-strokes	 . 12)
    (=cns11643-6	. #x4829)	; &M-07858; [40-09]
...
(define-char
  '((ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 13)
    (=ucs		. #x21D24)	; 𡴤
    (=cns11643-6	. #x522A)	; &I-C6-522A; [50-10]
...
(define-char
  '((morohashi-daikanwa	7867 0 0)
    ...
    (total-strokes	 . 21)
    (=ucs		. #x21D2B)	; 𡴫
    (=cns11643-7	. #x5330)	; &I-C7-5330; [51-16]
    ))
(define-char
  '((=>ucs		. #x21D2C)	; 𡴬
    (ideographic-radical . 45)	; ⼬
    ...
    (total-strokes	 . 24)
    (=cns11643-7	. #x5E5D)	; &M-07868; [62-61]
