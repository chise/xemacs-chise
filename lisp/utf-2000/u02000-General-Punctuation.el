...
(define-char
  '((name		. "HYPHEN")
    ...
    (japanese-jisx0208-1990	. #x213E)	; â€
    (ucs			. #x2010)	; â€
    ))
(define-char
...
(define-char
  '((name		. "EM DASH")
    ...
    (japanese-jisx0208-1990	. #x213D)	; â€”
    (ucs			. #x2014)	; â€”
    ))
(define-char
  '((name		. "HORIZONTAL BAR")
...
(define-char
  '((name		. "DOUBLE VERTICAL LINE")
    ...
    (japanese-jisx0208-1990	. #x2142)	; â€–
    (ucs			. #x2016)	; â€–
    ))
(define-char
...
(define-char
  '((name		. "LEFT SINGLE QUOTATION MARK")
    ...
    (japanese-jisx0208-1990	. #x2146)	; â€˜
    (ucs			. #x2018)	; â€˜
    ))
(define-char
  '((name		. "RIGHT SINGLE QUOTATION MARK")
    ...
    (japanese-jisx0208-1990	. #x2147)	; â€™
    (ucs			. #x2019)	; â€™
    ))
(define-char
...
(define-char
  '((name		. "LEFT DOUBLE QUOTATION MARK")
    ...
    (japanese-jisx0208-1990	. #x2148)	; â€œ
    (ucs			. #x201C)	; â€œ
    ))
(define-char
  '((name		. "RIGHT DOUBLE QUOTATION MARK")
    ...
    (japanese-jisx0208-1990	. #x2149)	; â€
    (ucs			. #x201D)	; â€
    ))
(define-char
...
(define-char
  '((name		. "DAGGER")
    ...
    (japanese-jisx0208-1990	. #x2277)	; â€ 
    (ucs			. #x2020)	; â€ 
    ))
(define-char
  '((name		. "DOUBLE DAGGER")
    ...
    (japanese-jisx0208-1990	. #x2278)	; â€¡
    (ucs			. #x2021)	; â€¡
    ))
(define-char
  '((name		. "BULLET")
...
(define-char
  '((name		. "TWO DOT LEADER")
    ...
    (japanese-jisx0208-1990	. #x2145)	; â€¥
    (ucs			. #x2025)	; â€¥
    ))
(define-char
  '((name		. "HORIZONTAL ELLIPSIS")
    ...
    (japanese-jisx0208-1990	. #x2144)	; â€¦
    (ucs			. #x2026)	; â€¦
    ))
(define-char
...
(define-char
  '((name		. "PER MILLE SIGN")
    ...
    (japanese-jisx0208-1990	. #x2273)	; â€°
    (ucs			. #x2030)	; â€°
    ))
(define-char
...
(define-char
  '((name		. "PRIME")
    ...
    (japanese-jisx0208-1990	. #x216C)	; â€²
    (ucs			. #x2032)	; â€²
    ))
(define-char
  '((name		. "DOUBLE PRIME")
    ...
    (japanese-jisx0208-1990	. #x216D)	; â€³
    (ucs			. #x2033)	; â€³
    ))
(define-char
  '((name		. "TRIPLE PRIME")
...
(define-char
  '((name		. "REFERENCE MARK")
    ...
    (japanese-jisx0208-1990	. #x2228)	; â€»
    (ucs			. #x203B)	; â€»
    ))
(define-char
...
(define-char
  '((name		. "FULLWIDTH OVERLINE")
    ...
    (japanese-jisx0208-1990	. #x2131)	; ø»¼
    ))
(define-char
  '((name		. "UNDERTIE")
