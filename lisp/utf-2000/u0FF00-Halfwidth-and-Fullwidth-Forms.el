...
(define-char
  '((name		. "FULLWIDTH EXCLAMATION MARK")
    ...
    (=jis-x0213-1	. #x212A)	; &I-JX1-212A; [01-10]
    (=big5		. #xA149)	; &I-B-A149;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH NUMBER SIGN")
    ...
    (=jis-x0213-1	. #x2174)	; &I-JX1-2174; [01-84]
    (=big5		. #xA1AD)	; &I-B-A1AD;
    (<-fullwidth
     ((name		  . "NUMBER SIGN")
      (=ucs		  . #x0023)	; #
...
(define-char
  '((name		. "FULLWIDTH DOLLAR SIGN")
    ...
    (=jis-x0213-1	. #x2170)	; &I-JX1-2170; [01-80]
    (=big5		. #xA243)	; &I-B-A243;
    (<-fullwidth
     ((name		  . "DOLLAR SIGN")
      (=ucs		  . #x0024)	; $
...
(define-char
  '((name		. "FULLWIDTH PERCENT SIGN")
    ...
    (=jis-x0213-1	. #x2173)	; &I-JX1-2173; [01-83]
    (=big5		. #xA248)	; &I-B-A248;
    (<-fullwidth
     ((name		  . "PERCENT SIGN")
      (=ucs		  . #x0025)	; %
...
(define-char
  '((name		. "FULLWIDTH AMPERSAND")
    ...
    (=jis-x0213-1	. #x2175)	; &I-JX1-2175; [01-85]
    (=big5		. #xA1AE)	; &I-B-A1AE;
    (<-fullwidth
     ((name		  . "AMPERSAND")
      (=ucs		  . #x0026)	; &
...
(define-char
  '((name		. "FULLWIDTH LEFT PARENTHESIS")
    ...
    (=jis-x0213-1	. #x214A)	; &I-JX1-214A; [01-42]
    (=big5		. #xA15D)	; &I-B-A15D;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH RIGHT PARENTHESIS")
    ...
    (=jis-x0213-1	. #x214B)	; &I-JX1-214B; [01-43]
    (=big5		. #xA15E)	; &I-B-A15E;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH ASTERISK")
    ...
    (=jis-x0213-1	. #x2176)	; &I-JX1-2176; [01-86]
    (=big5		. #xA1AF)	; &I-B-A1AF;
    (<-fullwidth
     ((name		  . "ASTERISK")
      (=ucs		  . #x002A)	; *
...
(define-char
  '((name		. "FULLWIDTH PLUS SIGN")
    ...
    (=jis-x0213-1	. #x215C)	; &I-JX1-215C; [01-60]
    (=big5		. #xA1CF)	; &I-B-A1CF;
    (<-fullwidth
     ((name		  . "PLUS SIGN")
      (=ucs		  . #x002B)	; +
...
(define-char
  '((name		. "FULLWIDTH COMMA")
    ...
    (=jis-x0213-1	. #x2124)	; &I-JX1-2124; [01-04]
    (=big5		. #xA141)	; &I-B-A141;
    (<-fullwidth
     ((name		  . "COMMA")
      (=ucs		  . #x002C)	; ,
...
(define-char
  '((name		. "FULLWIDTH HYPHEN-MINUS")
    ...
    (=jis-x0213-1	. #x2231)	; &I-JX1-2231; [02-17]
    (=big5		. #xA1D0)	; &I-B-A1D0;
    (<-fullwidth
     ((name		  . "HYPHEN-MINUS")
      (=ucs		  . #x002D)	; -
...
(define-char
  '((name		. "FULLWIDTH FULL STOP")
    ...
    (=jis-x0213-1	. #x2125)	; &I-JX1-2125; [01-05]
    (=big5		. #xA144)	; &I-B-A144;
    (<-fullwidth
     ((name		  . "FULL STOP")
      (=ucs		  . #x002E)	; .
...
(define-char
  '((name		. "FULLWIDTH SOLIDUS")
    ...
    (=jis-x0213-1	. #x213F)	; &I-JX1-213F; [01-31]
    (=big5		. #xA1FE)	; &I-B-A1FE;
    (<-fullwidth
     ((name		  . "SOLIDUS")
      (=ucs		  . #x002F)	; /
...
(define-char
  '((name		. "FULLWIDTH DIGIT ZERO")
    ...
    (=jis-x0213-1	. #x2330)	; &I-JX1-2330; [03-16]
    (=big5		. #xA2AF)	; &I-B-A2AF;
    (<-fullwidth
     ((name		  . "DIGIT ZERO")
      (=ucs		  . #x0030)	; 0
...
(define-char
  '((name		. "FULLWIDTH DIGIT ONE")
    ...
    (=jis-x0213-1	. #x2331)	; &I-JX1-2331; [03-17]
    (=big5		. #xA2B0)	; &I-B-A2B0;
    (<-fullwidth
     ((name		  . "DIGIT ONE")
      (=ucs		  . #x0031)	; 1
...
(define-char
  '((name		. "FULLWIDTH DIGIT TWO")
    ...
    (=jis-x0213-1	. #x2332)	; &I-JX1-2332; [03-18]
    (=big5		. #xA2B1)	; &I-B-A2B1;
    (<-fullwidth
     ((name		  . "DIGIT TWO")
      (=ucs		  . #x0032)	; 2
...
(define-char
  '((name		. "FULLWIDTH DIGIT THREE")
    ...
    (=jis-x0213-1	. #x2333)	; &I-JX1-2333; [03-19]
    (=big5		. #xA2B2)	; &I-B-A2B2;
    (<-fullwidth
     ((name		  . "DIGIT THREE")
      (=ucs		  . #x0033)	; 3
...
(define-char
  '((name		. "FULLWIDTH DIGIT FOUR")
    ...
    (=jis-x0213-1	. #x2334)	; &I-JX1-2334; [03-20]
    (=big5		. #xA2B3)	; &I-B-A2B3;
    (<-fullwidth
     ((name		  . "DIGIT FOUR")
      (=ucs		  . #x0034)	; 4
...
(define-char
  '((name		. "FULLWIDTH DIGIT FIVE")
    ...
    (=jis-x0213-1	. #x2335)	; &I-JX1-2335; [03-21]
    (=big5		. #xA2B4)	; &I-B-A2B4;
    (<-fullwidth
     ((name		  . "DIGIT FIVE")
      (=ucs		  . #x0035)	; 5
...
(define-char
  '((name		. "FULLWIDTH DIGIT SIX")
    ...
    (=jis-x0213-1	. #x2336)	; &I-JX1-2336; [03-22]
    (=big5		. #xA2B5)	; &I-B-A2B5;
    (<-fullwidth
     ((name		  . "DIGIT SIX")
      (=ucs		  . #x0036)	; 6
...
(define-char
  '((name		. "FULLWIDTH DIGIT SEVEN")
    ...
    (=jis-x0213-1	. #x2337)	; &I-JX1-2337; [03-23]
    (=big5		. #xA2B6)	; &I-B-A2B6;
    (<-fullwidth
     ((name		  . "DIGIT SEVEN")
      (=ucs		  . #x0037)	; 7
...
(define-char
  '((name		. "FULLWIDTH DIGIT EIGHT")
    ...
    (=jis-x0213-1	. #x2338)	; &I-JX1-2338; [03-24]
    (=big5		. #xA2B7)	; &I-B-A2B7;
    (<-fullwidth
     ((name		  . "DIGIT EIGHT")
      (=ucs		  . #x0038)	; 8
...
(define-char
  '((name		. "FULLWIDTH DIGIT NINE")
    ...
    (=jis-x0213-1	. #x2339)	; &I-JX1-2339; [03-25]
    (=big5		. #xA2B8)	; &I-B-A2B8;
    (<-fullwidth
     ((name		  . "DIGIT NINE")
      (=ucs		  . #x0039)	; 9
...
(define-char
  '((name		. "FULLWIDTH COLON")
    ...
    (=jis-x0213-1	. #x2127)	; &I-JX1-2127; [01-07]
    (=big5		. #xA147)	; &I-B-A147;
    (<-fullwidth
     ((name		  . "COLON")
      (=ucs		  . #x003A)	; :
...
(define-char
  '((name		. "FULLWIDTH SEMICOLON")
    ...
    (=jis-x0213-1	. #x2128)	; &I-JX1-2128; [01-08]
    (=big5		. #xA146)	; &I-B-A146;
    (<-fullwidth
     ((name		  . "SEMICOLON")
      (=ucs		  . #x003B)	; ;
...
(define-char
  '((name		. "FULLWIDTH LESS-THAN SIGN")
    ...
    (=jis-x0213-1	. #x2163)	; &I-JX1-2163; [01-67]
    (=big5		. #xA1D5)	; &I-B-A1D5;
    (<-fullwidth
     ((name		  . "LESS-THAN SIGN")
      (=ucs		  . #x003C)	; <
...
(define-char
  '((name		. "FULLWIDTH EQUALS SIGN")
    ...
    (=jis-x0213-1	. #x2161)	; &I-JX1-2161; [01-65]
    (=big5		. #xA1D7)	; &I-B-A1D7;
    (<-fullwidth
     ((name		  . "EQUALS SIGN")
      (=ucs		  . #x003D)	; =
...
(define-char
  '((name		. "FULLWIDTH GREATER-THAN SIGN")
    ...
    (=jis-x0213-1	. #x2164)	; &I-JX1-2164; [01-68]
    (=big5		. #xA1D6)	; &I-B-A1D6;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH QUESTION MARK")
    ...
    (=jis-x0213-1	. #x2129)	; &I-JX1-2129; [01-09]
    (=big5		. #xA148)	; &I-B-A148;
    (<-fullwidth
     ((name		  . "QUESTION MARK")
      (=ucs		  . #x003F)	; ?
...
(define-char
  '((name		. "FULLWIDTH COMMERCIAL AT")
    ...
    (=jis-x0213-1	. #x2177)	; &I-JX1-2177; [01-87]
    (=big5		. #xA249)	; &I-B-A249;
    (<-fullwidth
     ((name		  . "COMMERCIAL AT")
      (=ucs		  . #x0040)	; @
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER A")
    ...
    (=jis-x0213-1	. #x2341)	; &I-JX1-2341; [03-33]
    (=big5		. #xA2CF)	; &I-B-A2CF;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER B")
    ...
    (=jis-x0213-1	. #x2342)	; &I-JX1-2342; [03-34]
    (=big5		. #xA2D0)	; &I-B-A2D0;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER C")
    ...
    (=jis-x0213-1	. #x2343)	; &I-JX1-2343; [03-35]
    (=big5		. #xA2D1)	; &I-B-A2D1;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER D")
    ...
    (=jis-x0213-1	. #x2344)	; &I-JX1-2344; [03-36]
    (=big5		. #xA2D2)	; &I-B-A2D2;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER E")
    ...
    (=jis-x0213-1	. #x2345)	; &I-JX1-2345; [03-37]
    (=big5		. #xA2D3)	; &I-B-A2D3;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER F")
    ...
    (=jis-x0213-1	. #x2346)	; &I-JX1-2346; [03-38]
    (=big5		. #xA2D4)	; &I-B-A2D4;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER G")
    ...
    (=jis-x0213-1	. #x2347)	; &I-JX1-2347; [03-39]
    (=big5		. #xA2D5)	; &I-B-A2D5;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER H")
    ...
    (=jis-x0213-1	. #x2348)	; &I-JX1-2348; [03-40]
    (=big5		. #xA2D6)	; &I-B-A2D6;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER I")
    ...
    (=jis-x0213-1	. #x2349)	; &I-JX1-2349; [03-41]
    (=big5		. #xA2D7)	; &I-B-A2D7;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER J")
    ...
    (=jis-x0213-1	. #x234A)	; &I-JX1-234A; [03-42]
    (=big5		. #xA2D8)	; &I-B-A2D8;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER K")
    ...
    (=jis-x0213-1	. #x234B)	; &I-JX1-234B; [03-43]
    (=big5		. #xA2D9)	; &I-B-A2D9;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER L")
    ...
    (=jis-x0213-1	. #x234C)	; &I-JX1-234C; [03-44]
    (=big5		. #xA2DA)	; &I-B-A2DA;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER M")
    ...
    (=jis-x0213-1	. #x234D)	; &I-JX1-234D; [03-45]
    (=big5		. #xA2DB)	; &I-B-A2DB;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER N")
    ...
    (=jis-x0213-1	. #x234E)	; &I-JX1-234E; [03-46]
    (=big5		. #xA2DC)	; &I-B-A2DC;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER O")
    ...
    (=jis-x0213-1	. #x234F)	; &I-JX1-234F; [03-47]
    (=big5		. #xA2DD)	; &I-B-A2DD;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER P")
    ...
    (=jis-x0213-1	. #x2350)	; &I-JX1-2350; [03-48]
    (=big5		. #xA2DE)	; &I-B-A2DE;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER Q")
    ...
    (=jis-x0213-1	. #x2351)	; &I-JX1-2351; [03-49]
    (=big5		. #xA2DF)	; &I-B-A2DF;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER R")
    ...
    (=jis-x0213-1	. #x2352)	; &I-JX1-2352; [03-50]
    (=big5		. #xA2E0)	; &I-B-A2E0;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER S")
    ...
    (=jis-x0213-1	. #x2353)	; &I-JX1-2353; [03-51]
    (=big5		. #xA2E1)	; &I-B-A2E1;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER T")
    ...
    (=jis-x0213-1	. #x2354)	; &I-JX1-2354; [03-52]
    (=big5		. #xA2E2)	; &I-B-A2E2;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER U")
    ...
    (=jis-x0213-1	. #x2355)	; &I-JX1-2355; [03-53]
    (=big5		. #xA2E3)	; &I-B-A2E3;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER V")
    ...
    (=jis-x0213-1	. #x2356)	; &I-JX1-2356; [03-54]
    (=big5		. #xA2E4)	; &I-B-A2E4;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER W")
    ...
    (=jis-x0213-1	. #x2357)	; &I-JX1-2357; [03-55]
    (=big5		. #xA2E5)	; &I-B-A2E5;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER X")
    ...
    (=jis-x0213-1	. #x2358)	; &I-JX1-2358; [03-56]
    (=big5		. #xA2E6)	; &I-B-A2E6;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER Y")
    ...
    (=jis-x0213-1	. #x2359)	; &I-JX1-2359; [03-57]
    (=big5		. #xA2E7)	; &I-B-A2E7;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER Z")
    ...
    (=jis-x0213-1	. #x235A)	; &I-JX1-235A; [03-58]
    (=big5		. #xA2E8)	; &I-B-A2E8;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH REVERSE SOLIDUS")
    ...
    (=jis-x0213-1	. #x2140)	; &I-JX1-2140; [01-32]
    (=big5		. #xA240)	; &I-B-A240;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH CIRCUMFLEX ACCENT")
    ...
    (=jis-x0213-1	. #x2130)	; &I-JX1-2130; [01-16]
...
(define-char
  '((name		. "FULLWIDTH LOW LINE")
    ...
    (=jis-x0213-1	. #x2132)	; &I-JX1-2132; [01-18]
    (=big5		. #xA1C4)	; &I-B-A1C4;
    (<-fullwidth
     ((name		  . "LOW LINE")
      (=ucs		  . #x005F)	; _
...
(define-char
  '((name		. "FULLWIDTH GRAVE ACCENT")
    ...
    (=jis-x0213-1	. #x212E)	; &I-JX1-212E; [01-14]
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER A")
    ...
    (=jis-x0213-1	. #x2361)	; &I-JX1-2361; [03-65]
    (=big5		. #xA2E9)	; &I-B-A2E9;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER B")
    ...
    (=jis-x0213-1	. #x2362)	; &I-JX1-2362; [03-66]
    (=big5		. #xA2EA)	; &I-B-A2EA;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER C")
    ...
    (=jis-x0213-1	. #x2363)	; &I-JX1-2363; [03-67]
    (=big5		. #xA2EB)	; &I-B-A2EB;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER D")
    ...
    (=jis-x0213-1	. #x2364)	; &I-JX1-2364; [03-68]
    (=big5		. #xA2EC)	; &I-B-A2EC;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER E")
    ...
    (=jis-x0213-1	. #x2365)	; &I-JX1-2365; [03-69]
    (=big5		. #xA2ED)	; &I-B-A2ED;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER F")
    ...
    (=jis-x0213-1	. #x2366)	; &I-JX1-2366; [03-70]
    (=big5		. #xA2EE)	; &I-B-A2EE;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER G")
    ...
    (=jis-x0213-1	. #x2367)	; &I-JX1-2367; [03-71]
    (=big5		. #xA2EF)	; &I-B-A2EF;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER H")
    ...
    (=jis-x0213-1	. #x2368)	; &I-JX1-2368; [03-72]
    (=big5		. #xA2F0)	; &I-B-A2F0;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER I")
    ...
    (=jis-x0213-1	. #x2369)	; &I-JX1-2369; [03-73]
    (=big5		. #xA2F1)	; &I-B-A2F1;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER J")
    ...
    (=jis-x0213-1	. #x236A)	; &I-JX1-236A; [03-74]
    (=big5		. #xA2F2)	; &I-B-A2F2;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER K")
    ...
    (=jis-x0213-1	. #x236B)	; &I-JX1-236B; [03-75]
    (=big5		. #xA2F3)	; &I-B-A2F3;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER L")
    ...
    (=jis-x0213-1	. #x236C)	; &I-JX1-236C; [03-76]
    (=big5		. #xA2F4)	; &I-B-A2F4;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER M")
    ...
    (=jis-x0213-1	. #x236D)	; &I-JX1-236D; [03-77]
    (=big5		. #xA2F5)	; &I-B-A2F5;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER N")
    ...
    (=jis-x0213-1	. #x236E)	; &I-JX1-236E; [03-78]
    (=big5		. #xA2F6)	; &I-B-A2F6;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER O")
    ...
    (=jis-x0213-1	. #x236F)	; &I-JX1-236F; [03-79]
    (=big5		. #xA2F7)	; &I-B-A2F7;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER P")
    ...
    (=jis-x0213-1	. #x2370)	; &I-JX1-2370; [03-80]
    (=big5		. #xA2F8)	; &I-B-A2F8;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER Q")
    ...
    (=jis-x0213-1	. #x2371)	; &I-JX1-2371; [03-81]
    (=big5		. #xA2F9)	; &I-B-A2F9;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER R")
    ...
    (=jis-x0213-1	. #x2372)	; &I-JX1-2372; [03-82]
    (=big5		. #xA2FA)	; &I-B-A2FA;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER S")
    ...
    (=jis-x0213-1	. #x2373)	; &I-JX1-2373; [03-83]
    (=big5		. #xA2FB)	; &I-B-A2FB;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER T")
    ...
    (=jis-x0213-1	. #x2374)	; &I-JX1-2374; [03-84]
    (=big5		. #xA2FC)	; &I-B-A2FC;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER U")
    ...
    (=jis-x0213-1	. #x2375)	; &I-JX1-2375; [03-85]
    (=big5		. #xA2FD)	; &I-B-A2FD;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER V")
    ...
    (=jis-x0213-1	. #x2376)	; &I-JX1-2376; [03-86]
    (=big5		. #xA2FE)	; &I-B-A2FE;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER W")
    ...
    (=jis-x0213-1	. #x2377)	; &I-JX1-2377; [03-87]
    (=big5		. #xA340)	; &I-B-A340;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER X")
    ...
    (=jis-x0213-1	. #x2378)	; &I-JX1-2378; [03-88]
    (=big5		. #xA341)	; &I-B-A341;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER Y")
    ...
    (=jis-x0213-1	. #x2379)	; &I-JX1-2379; [03-89]
    (=big5		. #xA342)	; &I-B-A342;
...
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER Z")
    ...
    (=jis-x0213-1	. #x237A)	; &I-JX1-237A; [03-90]
    (=big5		. #xA343)	; &I-B-A343;
...
(define-char
  '((name		. "FULLWIDTH LEFT CURLY BRACKET")
    ...
    (=jis-x0213-1	. #x2150)	; &I-JX1-2150; [01-48]
    (=big5		. #xA161)	; &I-B-A161;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH VERTICAL LINE")
    ...
    (=jis-x0213-1	. #x2143)	; &I-JX1-2143; [01-35]
    (=big5		. #xA155)	; &I-B-A155;
    (<-fullwidth
     ((name		  . "VERTICAL LINE")
      (=ucs		  . #x007C)	; |
...
(define-char
  '((name		. "FULLWIDTH RIGHT CURLY BRACKET")
    ...
    (=jis-x0213-1	. #x2151)	; &I-JX1-2151; [01-49]
    (=big5		. #xA162)	; &I-B-A162;
    (<-fullwidth
...
(define-char
  '((name		. "FULLWIDTH TILDE")
    ...
    (=jis-x0213-1	. #x2232)	; &I-JX1-2232; [02-18]
    (=big5		. #xA1E3)	; &I-B-A1E3;
...
(define-char
  '((name		. "FULLWIDTH LEFT WHITE PARENTHESIS")
    (=ucs		. #xFF5F)	; ｟
    (=jis-x0213-1	. #x2256)	; &I-JX1-2256; [02-54]
    ))
(define-char
  '((name		. "FULLWIDTH RIGHT WHITE PARENTHESIS")
    (=ucs		. #xFF60)	; ｠
    (=jis-x0213-1	. #x2257)	; &I-JX1-2257; [02-55]
    ))
(define-char
...
(define-char
  '((name		. "FULLWIDTH CENT SIGN")
    ...
    (=jis-x0213-1	. #x2171)	; &I-JX1-2171; [01-81]
    (=big5		. #xA246)	; &I-B-A246;
    (<-fullwidth
     ((name		  . "CENT SIGN")
      (=ucs		  . #x00A2)	; ¢
...
(define-char
  '((name		. "FULLWIDTH POUND SIGN")
    ...
    (=jis-x0213-1	. #x2172)	; &I-JX1-2172; [01-82]
    (=big5		. #xA247)	; &I-B-A247;
    (<-fullwidth
     ((name		  . "POUND SIGN")
      (=ucs		  . #x00A3)	; £
...
(define-char
  '((name		. "FULLWIDTH MACRON")
    ...
    (=jis-x0213-1	. #x292B)	; &I-JX1-292B; [09-11]
    (=big5		. #xA1C3)	; &I-B-A1C3;
...
(define-char
  '((name		. "FULLWIDTH YEN SIGN")
    ...
    (=jis-x0213-1	. #x216F)	; &I-JX1-216F; [01-79]
    (=big5		. #xA244)	; &I-B-A244;
    (<-fullwidth
     ((name		  . "YEN SIGN")
      (=ucs		  . #x00A5)	; ¥
