(define-char
  '((name		. "FULLWIDTH EXCLAMATION MARK")
    ...
    (japanese-jisx0208-1990	. #x212A)	; ï¼
    (ucs			. #xFF01)	; ï¼
    ))
(define-char
...
(define-char
  '((name		. "FULLWIDTH NUMBER SIGN")
    ...
    (japanese-jisx0208-1990	. #x2174)	; ï¼ƒ
    (ucs			. #xFF03)	; ï¼ƒ
    ))
(define-char
  '((name		. "FULLWIDTH DOLLAR SIGN")
    ...
    (japanese-jisx0208-1990	. #x2170)	; ï¼„
    (ucs			. #xFF04)	; ï¼„
    ))
(define-char
  '((name		. "FULLWIDTH PERCENT SIGN")
    ...
    (japanese-jisx0208-1990	. #x2173)	; ï¼…
    (ucs			. #xFF05)	; ï¼…
    ))
(define-char
  '((name		. "FULLWIDTH AMPERSAND")
    ...
    (japanese-jisx0208-1990	. #x2175)	; ï¼†
    (ucs			. #xFF06)	; ï¼†
    ))
(define-char
...
(define-char
  '((name		. "FULLWIDTH LEFT PARENTHESIS")
    ...
    (japanese-jisx0208-1990	. #x214A)	; ï¼ˆ
    (ucs			. #xFF08)	; ï¼ˆ
    ))
(define-char
  '((name		. "FULLWIDTH RIGHT PARENTHESIS")
    ...
    (japanese-jisx0208-1990	. #x214B)	; ï¼‰
    (ucs			. #xFF09)	; ï¼‰
    ))
(define-char
  '((name		. "FULLWIDTH ASTERISK")
    ...
    (japanese-jisx0208-1990	. #x2176)	; ï¼Š
    (ucs			. #xFF0A)	; ï¼Š
    ))
(define-char
  '((name		. "FULLWIDTH PLUS SIGN")
    ...
    (japanese-jisx0208-1990	. #x215C)	; ï¼‹
    (ucs			. #xFF0B)	; ï¼‹
    ))
(define-char
  '((name		. "FULLWIDTH COMMA")
    ...
    (japanese-jisx0208-1990	. #x2124)	; ï¼Œ
    (ucs			. #xFF0C)	; ï¼Œ
    ))
(define-char
...
(define-char
  '((name		. "FULLWIDTH FULL STOP")
    ...
    (japanese-jisx0208-1990	. #x2125)	; ï¼Ž
    (ucs			. #xFF0E)	; ï¼Ž
    ))
(define-char
  '((name		. "FULLWIDTH SOLIDUS")
    ...
    (japanese-jisx0208-1990	. #x213F)	; ï¼
    (ucs			. #xFF0F)	; ï¼
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT ZERO")
    ...
    (japanese-jisx0208-1990	. #x2330)	; ï¼
    (ucs			. #xFF10)	; ï¼
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT ONE")
    ...
    (japanese-jisx0208-1990	. #x2331)	; ï¼‘
    (ucs			. #xFF11)	; ï¼‘
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT TWO")
    ...
    (japanese-jisx0208-1990	. #x2332)	; ï¼’
    (ucs			. #xFF12)	; ï¼’
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT THREE")
    ...
    (japanese-jisx0208-1990	. #x2333)	; ï¼“
    (ucs			. #xFF13)	; ï¼“
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT FOUR")
    ...
    (japanese-jisx0208-1990	. #x2334)	; ï¼”
    (ucs			. #xFF14)	; ï¼”
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT FIVE")
    ...
    (japanese-jisx0208-1990	. #x2335)	; ï¼•
    (ucs			. #xFF15)	; ï¼•
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT SIX")
    ...
    (japanese-jisx0208-1990	. #x2336)	; ï¼–
    (ucs			. #xFF16)	; ï¼–
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT SEVEN")
    ...
    (japanese-jisx0208-1990	. #x2337)	; ï¼—
    (ucs			. #xFF17)	; ï¼—
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT EIGHT")
    ...
    (japanese-jisx0208-1990	. #x2338)	; ï¼˜
    (ucs			. #xFF18)	; ï¼˜
    ))
(define-char
  '((name		. "FULLWIDTH DIGIT NINE")
    ...
    (japanese-jisx0208-1990	. #x2339)	; ï¼™
    (ucs			. #xFF19)	; ï¼™
    ))
(define-char
  '((name		. "FULLWIDTH COLON")
    ...
    (japanese-jisx0208-1990	. #x2127)	; ï¼š
    (ucs			. #xFF1A)	; ï¼š
    ))
(define-char
  '((name		. "FULLWIDTH SEMICOLON")
    ...
    (japanese-jisx0208-1990	. #x2128)	; ï¼›
    (ucs			. #xFF1B)	; ï¼›
    ))
(define-char
  '((name		. "FULLWIDTH LESS-THAN SIGN")
    ...
    (japanese-jisx0208-1990	. #x2163)	; ï¼œ
    (ucs			. #xFF1C)	; ï¼œ
    ))
(define-char
  '((name		. "FULLWIDTH EQUALS SIGN")
    ...
    (japanese-jisx0208-1990	. #x2161)	; ï¼
    (ucs			. #xFF1D)	; ï¼
    ))
(define-char
  '((name		. "FULLWIDTH GREATER-THAN SIGN")
    ...
    (japanese-jisx0208-1990	. #x2164)	; ï¼ž
    (ucs			. #xFF1E)	; ï¼ž
    ))
(define-char
  '((name		. "FULLWIDTH QUESTION MARK")
    ...
    (japanese-jisx0208-1990	. #x2129)	; ï¼Ÿ
    (ucs			. #xFF1F)	; ï¼Ÿ
    ))
(define-char
  '((name		. "FULLWIDTH COMMERCIAL AT")
    ...
    (japanese-jisx0208-1990	. #x2177)	; ï¼ 
    (ucs			. #xFF20)	; ï¼ 
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER A")
    ...
    (japanese-jisx0208-1990	. #x2341)	; ï¼¡
    (ucs			. #xFF21)	; ï¼¡
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER B")
    ...
    (japanese-jisx0208-1990	. #x2342)	; ï¼¢
    (ucs			. #xFF22)	; ï¼¢
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER C")
    ...
    (japanese-jisx0208-1990	. #x2343)	; ï¼£
    (ucs			. #xFF23)	; ï¼£
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER D")
    ...
    (japanese-jisx0208-1990	. #x2344)	; ï¼¤
    (ucs			. #xFF24)	; ï¼¤
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER E")
    ...
    (japanese-jisx0208-1990	. #x2345)	; ï¼¥
    (ucs			. #xFF25)	; ï¼¥
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER F")
    ...
    (japanese-jisx0208-1990	. #x2346)	; ï¼¦
    (ucs			. #xFF26)	; ï¼¦
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER G")
    ...
    (japanese-jisx0208-1990	. #x2347)	; ï¼§
    (ucs			. #xFF27)	; ï¼§
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER H")
    ...
    (japanese-jisx0208-1990	. #x2348)	; ï¼¨
    (ucs			. #xFF28)	; ï¼¨
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER I")
    ...
    (japanese-jisx0208-1990	. #x2349)	; ï¼©
    (ucs			. #xFF29)	; ï¼©
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER J")
    ...
    (japanese-jisx0208-1990	. #x234A)	; ï¼ª
    (ucs			. #xFF2A)	; ï¼ª
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER K")
    ...
    (japanese-jisx0208-1990	. #x234B)	; ï¼«
    (ucs			. #xFF2B)	; ï¼«
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER L")
    ...
    (japanese-jisx0208-1990	. #x234C)	; ï¼¬
    (ucs			. #xFF2C)	; ï¼¬
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER M")
    ...
    (japanese-jisx0208-1990	. #x234D)	; ï¼­
    (ucs			. #xFF2D)	; ï¼­
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER N")
    ...
    (japanese-jisx0208-1990	. #x234E)	; ï¼®
    (ucs			. #xFF2E)	; ï¼®
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER O")
    ...
    (japanese-jisx0208-1990	. #x234F)	; ï¼¯
    (ucs			. #xFF2F)	; ï¼¯
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER P")
    ...
    (japanese-jisx0208-1990	. #x2350)	; ï¼°
    (ucs			. #xFF30)	; ï¼°
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER Q")
    ...
    (japanese-jisx0208-1990	. #x2351)	; ï¼±
    (ucs			. #xFF31)	; ï¼±
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER R")
    ...
    (japanese-jisx0208-1990	. #x2352)	; ï¼²
    (ucs			. #xFF32)	; ï¼²
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER S")
    ...
    (japanese-jisx0208-1990	. #x2353)	; ï¼³
    (ucs			. #xFF33)	; ï¼³
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER T")
    ...
    (japanese-jisx0208-1990	. #x2354)	; ï¼´
    (ucs			. #xFF34)	; ï¼´
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER U")
    ...
    (japanese-jisx0208-1990	. #x2355)	; ï¼µ
    (ucs			. #xFF35)	; ï¼µ
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER V")
    ...
    (japanese-jisx0208-1990	. #x2356)	; ï¼¶
    (ucs			. #xFF36)	; ï¼¶
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER W")
    ...
    (japanese-jisx0208-1990	. #x2357)	; ï¼·
    (ucs			. #xFF37)	; ï¼·
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER X")
    ...
    (japanese-jisx0208-1990	. #x2358)	; ï¼¸
    (ucs			. #xFF38)	; ï¼¸
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER Y")
    ...
    (japanese-jisx0208-1990	. #x2359)	; ï¼¹
    (ucs			. #xFF39)	; ï¼¹
    ))
(define-char
  '((name		. "FULLWIDTH LATIN CAPITAL LETTER Z")
    ...
    (japanese-jisx0208-1990	. #x235A)	; ï¼º
    (ucs			. #xFF3A)	; ï¼º
    ))
(define-char
  '((name		. "FULLWIDTH LEFT SQUARE BRACKET")
    ...
    (japanese-jisx0208-1990	. #x214E)	; ï¼»
    (ucs			. #xFF3B)	; ï¼»
    ))
(define-char
  '((name		. "FULLWIDTH REVERSE SOLIDUS")
    ...
    (japanese-jisx0208-1990	. #x2140)	; ï¼¼
    (ucs			. #xFF3C)	; ï¼¼
    ))
(define-char
  '((name		. "FULLWIDTH RIGHT SQUARE BRACKET")
    ...
    (japanese-jisx0208-1990	. #x214F)	; ï¼½
    (ucs			. #xFF3D)	; ï¼½
    ))
(define-char
  '((name		. "FULLWIDTH CIRCUMFLEX ACCENT")
    ...
    (japanese-jisx0208-1990	. #x2130)	; ï¼¾
    (ucs			. #xFF3E)	; ï¼¾
    ))
(define-char
  '((name		. "FULLWIDTH LOW LINE")
    ...
    (japanese-jisx0208-1990	. #x2132)	; ï¼¿
    (ucs			. #xFF3F)	; ï¼¿
    ))
(define-char
  '((name		. "FULLWIDTH GRAVE ACCENT")
    ...
    (japanese-jisx0208-1990	. #x212E)	; ï½€
    (ucs			. #xFF40)	; ï½€
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER A")
    ...
    (japanese-jisx0208-1990	. #x2361)	; ï½
    (ucs			. #xFF41)	; ï½
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER B")
    ...
    (japanese-jisx0208-1990	. #x2362)	; ï½‚
    (ucs			. #xFF42)	; ï½‚
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER C")
    ...
    (japanese-jisx0208-1990	. #x2363)	; ï½ƒ
    (ucs			. #xFF43)	; ï½ƒ
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER D")
    ...
    (japanese-jisx0208-1990	. #x2364)	; ï½„
    (ucs			. #xFF44)	; ï½„
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER E")
    ...
    (japanese-jisx0208-1990	. #x2365)	; ï½…
    (ucs			. #xFF45)	; ï½…
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER F")
    ...
    (japanese-jisx0208-1990	. #x2366)	; ï½†
    (ucs			. #xFF46)	; ï½†
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER G")
    ...
    (japanese-jisx0208-1990	. #x2367)	; ï½‡
    (ucs			. #xFF47)	; ï½‡
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER H")
    ...
    (japanese-jisx0208-1990	. #x2368)	; ï½ˆ
    (ucs			. #xFF48)	; ï½ˆ
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER I")
    ...
    (japanese-jisx0208-1990	. #x2369)	; ï½‰
    (ucs			. #xFF49)	; ï½‰
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER J")
    ...
    (japanese-jisx0208-1990	. #x236A)	; ï½Š
    (ucs			. #xFF4A)	; ï½Š
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER K")
    ...
    (japanese-jisx0208-1990	. #x236B)	; ï½‹
    (ucs			. #xFF4B)	; ï½‹
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER L")
    ...
    (japanese-jisx0208-1990	. #x236C)	; ï½Œ
    (ucs			. #xFF4C)	; ï½Œ
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER M")
    ...
    (japanese-jisx0208-1990	. #x236D)	; ï½
    (ucs			. #xFF4D)	; ï½
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER N")
    ...
    (japanese-jisx0208-1990	. #x236E)	; ï½Ž
    (ucs			. #xFF4E)	; ï½Ž
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER O")
    ...
    (japanese-jisx0208-1990	. #x236F)	; ï½
    (ucs			. #xFF4F)	; ï½
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER P")
    ...
    (japanese-jisx0208-1990	. #x2370)	; ï½
    (ucs			. #xFF50)	; ï½
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER Q")
    ...
    (japanese-jisx0208-1990	. #x2371)	; ï½‘
    (ucs			. #xFF51)	; ï½‘
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER R")
    ...
    (japanese-jisx0208-1990	. #x2372)	; ï½’
    (ucs			. #xFF52)	; ï½’
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER S")
    ...
    (japanese-jisx0208-1990	. #x2373)	; ï½“
    (ucs			. #xFF53)	; ï½“
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER T")
    ...
    (japanese-jisx0208-1990	. #x2374)	; ï½”
    (ucs			. #xFF54)	; ï½”
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER U")
    ...
    (japanese-jisx0208-1990	. #x2375)	; ï½•
    (ucs			. #xFF55)	; ï½•
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER V")
    ...
    (japanese-jisx0208-1990	. #x2376)	; ï½–
    (ucs			. #xFF56)	; ï½–
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER W")
    ...
    (japanese-jisx0208-1990	. #x2377)	; ï½—
    (ucs			. #xFF57)	; ï½—
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER X")
    ...
    (japanese-jisx0208-1990	. #x2378)	; ï½˜
    (ucs			. #xFF58)	; ï½˜
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER Y")
    ...
    (japanese-jisx0208-1990	. #x2379)	; ï½™
    (ucs			. #xFF59)	; ï½™
    ))
(define-char
  '((name		. "FULLWIDTH LATIN SMALL LETTER Z")
    ...
    (japanese-jisx0208-1990	. #x237A)	; ï½š
    (ucs			. #xFF5A)	; ï½š
    ))
(define-char
  '((name		. "FULLWIDTH LEFT CURLY BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2150)	; ï½›
    (ucs			. #xFF5B)	; ï½›
    ))
(define-char
  '((name		. "FULLWIDTH VERTICAL LINE")
    ...
    (japanese-jisx0208-1990	. #x2143)	; ï½œ
    (ucs			. #xFF5C)	; ï½œ
    ))
(define-char
  '((name		. "FULLWIDTH RIGHT CURLY BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2151)	; ï½
    (ucs			. #xFF5D)	; ï½
    ))
(define-char
...
(define-char
  '((name		. "FULLWIDTH CENT SIGN")
    ...
    (japanese-jisx0208-1990	. #x2171)	; ï¿ 
    (ucs			. #xFFE0)	; ï¿ 
    ))
(define-char
  '((name		. "FULLWIDTH POUND SIGN")
    ...
    (japanese-jisx0208-1990	. #x2172)	; ï¿¡
    (ucs			. #xFFE1)	; ï¿¡
    ))
(define-char
  '((name		. "FULLWIDTH NOT SIGN")
    ...
    (japanese-jisx0208-1990	. #x224C)	; ï¿¢
    (ucs			. #xFFE2)	; ï¿¢
    ))
(define-char
...
(define-char
  '((name		. "FULLWIDTH YEN SIGN")
    ...
    (japanese-jisx0208-1990	. #x216F)	; ï¿¥
    (ucs			. #xFFE5)	; ï¿¥
    ))
(define-char
