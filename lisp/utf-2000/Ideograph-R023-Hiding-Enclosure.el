...
(define-char
  '((<-denotational
    ...
    (=>>ucs@unicode	. #x5339)	; 匹󠄀
    (=ucs@unicode	. #x5339)	; 匹󠄀
    (=jis-x0208		. #x4924)	; 匹󠄀 [41-04]
...
(define-char
  '((<-denotational
	...
	(=ucs		    . #x2FF7)	; ⿷
      ...
      (=ucs@unicode	  . #x533B)	; 医󠄀
      (=jis-x0208	  . #x3065)	; 医󠄀 [16-69]
...
(define-char
  '((<-denotational
    ...
    (ideographic-strokes . 5)
    (total-strokes	 . 7)
    (=ucs@iso		. #x20971)	; &M-02681;
    (=cns11643-6	. #x2637)	; &M-02681; [06-23]
...
(define-char
  '((<-denotational
    ...
    (=ucs@unicode	. #x533F)	; 匿󠄀
    (=jis-x0208		. #x463F)	; 匿󠄀 [38-31]
...
(define-char
  '((=>ucs		. #x3538)	; 㔸
    ...
    (=cns11643-4	. #x3650)	; &M-02692; [22-48]
