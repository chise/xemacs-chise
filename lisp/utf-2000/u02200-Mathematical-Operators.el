(define-char
  '((name		. "FOR ALL")
    ...
    (japanese-jisx0208-1990	. #x224F)	; âˆ€
    (ucs			. #x2200)	; âˆ€
    ))
(define-char
  '((name		. "COMPLEMENT")
...
(define-char
  '((name		. "PARTIAL DIFFERENTIAL")
    ...
    (japanese-jisx0208-1990	. #x225F)	; âˆ‚
    (ucs			. #x2202)	; âˆ‚
    ))
(define-char
  '((name		. "THERE EXISTS")
    ...
    (japanese-jisx0208-1990	. #x2250)	; âˆƒ
    (ucs			. #x2203)	; âˆƒ
    ))
(define-char
...
(define-char
  '((name		. "NABLA")
    ...
    (japanese-jisx0208-1990	. #x2260)	; âˆ‡
    (ucs			. #x2207)	; âˆ‡
    ))
(define-char
  '((name		. "ELEMENT OF")
    ...
    (japanese-jisx0208-1990	. #x223A)	; âˆˆ
    (ucs			. #x2208)	; âˆˆ
    ))
(define-char
...
(define-char
  '((name		. "CONTAINS AS MEMBER")
    ...
    (japanese-jisx0208-1990	. #x223B)	; âˆ‹
    (ucs			. #x220B)	; âˆ‹
    ))
(define-char
...
(define-char
  '((name		. "MINUS SIGN")
    ...
    (japanese-jisx0208-1990	. #x215D)	; âˆ’
    (ucs			. #x2212)	; âˆ’
    ))
(define-char
...
(define-char
  '((name		. "SQUARE ROOT")
    ...
    (japanese-jisx0208-1990	. #x2265)	; âˆš
    (ucs			. #x221A)	; âˆš
    ))
(define-char
  '((name		. "CUBE ROOT")
...
(define-char
  '((name		. "PROPORTIONAL TO")
    ...
    (japanese-jisx0208-1990	. #x2267)	; âˆ
    (ucs			. #x221D)	; âˆ
    ))
(define-char
  '((name		. "INFINITY")
    ...
    (japanese-jisx0208-1990	. #x2167)	; âˆž
    (ucs			. #x221E)	; âˆž
    ))
(define-char
  '((name		. "RIGHT ANGLE")
...
(define-char
  '((name		. "ANGLE")
    ...
    (japanese-jisx0208-1990	. #x225C)	; âˆ 
    (ucs			. #x2220)	; âˆ 
    ))
(define-char
  '((name		. "MEASURED ANGLE")
...
(define-char
  '((name		. "LOGICAL AND")
    ...
    (japanese-jisx0208-1990	. #x224A)	; âˆ§
    (ucs			. #x2227)	; âˆ§
    ))
(define-char
  '((name		. "LOGICAL OR")
    ...
    (japanese-jisx0208-1990	. #x224B)	; âˆ¨
    (ucs			. #x2228)	; âˆ¨
    ))
(define-char
  '((name		. "INTERSECTION")
    ...
    (japanese-jisx0208-1990	. #x2241)	; âˆ©
    (ucs			. #x2229)	; âˆ©
    ))
(define-char
  '((name		. "UNION")
    ...
    (japanese-jisx0208-1990	. #x2240)	; âˆª
    (ucs			. #x222A)	; âˆª
    ))
(define-char
  '((name		. "INTEGRAL")
    ...
    (japanese-jisx0208-1990	. #x2269)	; âˆ«
    (ucs			. #x222B)	; âˆ«
    ))
(define-char
  '((name		. "DOUBLE INTEGRAL")
    ...
    (japanese-jisx0208-1990	. #x226A)	; âˆ¬
    (ucs			. #x222C)	; âˆ¬
    ))
(define-char
...
(define-char
  '((name		. "THEREFORE")
    ...
    (japanese-jisx0208-1990	. #x2168)	; âˆ´
    (ucs			. #x2234)	; âˆ´
    ))
(define-char
  '((name		. "BECAUSE")
    ...
    (japanese-jisx0208-1990	. #x2268)	; âˆµ
    (ucs			. #x2235)	; âˆµ
    ))
(define-char
  '((name		. "RATIO")
...
(define-char
  '((name		. "REVERSED TILDE")
    ...
    (japanese-jisx0208-1990	. #x2266)	; âˆ½
    (ucs			. #x223D)	; âˆ½
    ))
(define-char
...
(define-char
  '((name		. "APPROXIMATELY EQUAL TO OR THE IMAGE OF")
    ...
    (japanese-jisx0208-1990	. #x2262)	; â‰’
    (ucs			. #x2252)	; â‰’
    ))
(define-char
...
(define-char
  '((name		. "NOT EQUAL TO")
    ...
    (japanese-jisx0208-1990	. #x2162)	; â‰ 
    (ucs			. #x2260)	; â‰ 
    ))
(define-char
  '((name		. "IDENTICAL TO")
    ...
    (japanese-jisx0208-1990	. #x2261)	; â‰¡
    (ucs			. #x2261)	; â‰¡
    ))
(define-char
...
(define-char
  '((name		. "LESS-THAN OVER EQUAL TO")
    ...
    (japanese-jisx0208-1990	. #x2165)	; â‰¦
    (ucs			. #x2266)	; â‰¦
    ))
(define-char
  '((name		. "GREATER-THAN OVER EQUAL TO")
    ...
    (japanese-jisx0208-1990	. #x2166)	; â‰§
    (ucs			. #x2267)	; â‰§
    ))
(define-char
...
(define-char
  '((name		. "MUCH LESS-THAN")
    ...
    (japanese-jisx0208-1990	. #x2263)	; â‰ª
    (ucs			. #x226A)	; â‰ª
    ))
(define-char
  '((name		. "MUCH GREATER-THAN")
    ...
    (japanese-jisx0208-1990	. #x2264)	; â‰«
    (ucs			. #x226B)	; â‰«
    ))
(define-char
  '((name		. "BETWEEN")
...
(define-char
  '((name		. "SUBSET OF")
    ...
    (japanese-jisx0208-1990	. #x223E)	; âŠ‚
    (ucs			. #x2282)	; âŠ‚
    ))
(define-char
  '((name		. "SUPERSET OF")
    ...
    (japanese-jisx0208-1990	. #x223F)	; âŠƒ
    (ucs			. #x2283)	; âŠƒ
    ))
(define-char
...
(define-char
  '((name		. "SUBSET OF OR EQUAL TO")
    ...
    (japanese-jisx0208-1990	. #x223C)	; âŠ†
    (ucs			. #x2286)	; âŠ†
    ))
(define-char
  '((name		. "SUPERSET OF OR EQUAL TO")
    ...
    (japanese-jisx0208-1990	. #x223D)	; âŠ‡
    (ucs			. #x2287)	; âŠ‡
    ))
(define-char
...
(define-char
  '((name		. "UP TACK")
    ...
    (japanese-jisx0208-1990	. #x225D)	; âŠ¥
    (ucs			. #x22A5)	; âŠ¥
    ))
(define-char
  '((name		. "ASSERTION")
