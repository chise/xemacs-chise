...
(define-char
  '((morohashi-daikanwa	30597 0 0)
    ...
    (ideographic-strokes . 1)
    (total-strokes	 . 7)
    (chinese-gb2312	. #x413C)	; ø»„µŸ
    (chinese-isoir165	. #x413C)	; ø»¯
    (chinese-cns11643-1 . #x4B40)	; ø»’€§
    (ucs		. #x826F)	; è‰¯
    ))
(define-char
  '((ideographic-radical . 138)	; â¾‰
...
(define-char
  '((ideographic-radical . 138)	; â¾‰
    ...
    (total-strokes	 . 8)
    (chinese-gb2312	. #x3C68)	; ø»„®µ
    (chinese-isoir165	. #x3C68)	; ø»—…
    (ucs		. #x8270)	; è‰°
    ))
(define-char
  '((ideographic-radical . 138)	; â¾‰
