...
(define-char
  '((name		. "ARC")
    ...
    (mirrored		. nil)
    (=gb2312		. #x2150)	; �����
    (=jis-x0208-1983	. #x225E)	; �����
    (=ks-x1001		. #x2152)	; �����
    (=jis-x0208-1990	. #x225E)	; �����
    (=ucs		. #x2312)	; ⌒
    ))
(define-char
  '((name		. "SEGMENT")
