...
(define-char
  '((name		. "BLACK STAR")
    ...
    (bidi-category	. "ON")
    (mirrored		. nil)
    (japanese-jisx0208-1978	. #x217A)	; ø»½™
    (chinese-gb2312		. #x216F)	; ø»„‡’
    (japanese-jisx0208		. #x217A)	; ø»†‘¡
    (korean-ksc5601		. #x215A)	; ø»ˆ›…
    (chinese-cns11643-1		. #x2178)	; ø»‘ƒ³
    (japanese-jisx0208-1990	. #x217A)	; â˜…
    (ucs			. #x2605)	; â˜…
    ))
(define-char
  '((name		. "WHITE STAR")
    ...
    (bidi-category	. "ON")
    (mirrored		. nil)
    (japanese-jisx0208-1978	. #x2179)	; ø»½˜
    (chinese-gb2312		. #x216E)	; ø»„‡‘
    (japanese-jisx0208		. #x2179)	; ø»†‘ 
    (korean-ksc5601		. #x2159)	; ø»ˆ›„
    (chinese-cns11643-1		. #x2177)	; ø»‘ƒ²
    (japanese-jisx0208-1990	. #x2179)	; â˜†
    (ucs			. #x2606)	; â˜†
    ))
(define-char
  '((name		. "LIGHTNING")
...
(define-char
  '((name		. "WHITE SHOGI PIECE")
    (japanese-jisx0213-1	. #x2664)	; â˜–
    (ucs			. #x2616)	; â˜–
    ))
(define-char
  '((name		. "BLACK SHOGI PIECE")
    (japanese-jisx0213-1	. #x2665)	; â˜—
    (ucs			. #x2617)	; â˜—
    ))
(define-char
...
(define-char
  '((name		. "FEMALE SIGN")
    ...
    (bidi-category	. "ON")
    (mirrored		. nil)
    (japanese-jisx0208-1978	. #x216A)	; ø»½‰
    (chinese-gb2312		. #x2162)	; ø»„‡…
    (japanese-jisx0208		. #x216A)	; ø»†‘‘
    (korean-ksc5601		. #x214F)	; ø»ˆšº
    (chinese-cns11643-1		. #x2251)	; ø»‘„ª
    (japanese-jisx0208-1990	. #x216A)	; â™€
    (ucs			. #x2640)	; â™€
    ))
(define-char
  '((name		. "EARTH")
...
(define-char
  '((name		. "MALE SIGN")
    ...
    (bidi-category	. "ON")
    (mirrored		. nil)
    (japanese-jisx0208-1978	. #x2169)	; ø»½ˆ
    (chinese-gb2312		. #x2161)	; ø»„‡„
    (japanese-jisx0208		. #x2169)	; ø»†‘
    (korean-ksc5601		. #x214E)	; ø»ˆš¹
    (chinese-cns11643-1		. #x2252)	; ø»‘„«
    (japanese-jisx0208-1990	. #x2169)	; â™‚
    (ucs			. #x2642)	; â™‚
    ))
(define-char
  '((name		. "JUPITER")
...
(define-char
  '((name		. "EIGHTH NOTE")
    ...
    (japanese-jisx0208-1990	. #x2276)	; â™ª
    (ucs			. #x266A)	; â™ª
    ))
(define-char
...
(define-char
  '((name		. "MUSIC FLAT SIGN")
    ...
    (japanese-jisx0208-1990	. #x2275)	; â™­
    (ucs			. #x266D)	; â™­
    ))
(define-char
...
(define-char
  '((name		. "MUSIC SHARP SIGN")
    ...
    (japanese-jisx0208-1990	. #x2274)	; â™¯
    (ucs			. #x266F)	; â™¯
    ))
(define-char
