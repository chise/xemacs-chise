...
(define-char
  '((name		. "BOPOMOFO LETTER K")
    ...
    (chinese-isoir165	. #x284E)	; ø»Œ¹“
    (chinese-cns11643-1 . #x2550)	; ø»‘‰ƒ
    (chinese-big5	. #xA37D)	; øºŸ ·
    (ucs		. #x310E)	; ã„Ž
    ))
(define-char
...
(define-char
  '((name		. "BOPOMOFO LETTER C")
    ...
    (total-strokes	 . 2)
    (->ideograph
     ((ideograph-daikanwa . 9)))
    (chinese-gb2312	. #x2858)	; ø»„‘
    (chinese-isoir165	. #x2858)	; ø»Œ¹
    (chinese-cns11643-1 . #x255A)	; ø»‘‰
    (chinese-big5	. #xA3A9)	; øºŸ¡
    (ucs		. #x3118)	; ã„˜
    ))
(define-char
...
(define-char
  '((name		. "BOPOMOFO LETTER O")
    ...
    (total-strokes	 . 2)
    (->ideograph
     ((ideograph-daikanwa . 4)))
    (chinese-gb2312	. #x285B)	; ø»„‘
    (chinese-isoir165	. #x285B)	; ø»Œ¹ 
    (chinese-cns11643-1 . #x255D)	; ø»‘‰
    (chinese-big5	. #xA3AC)	; øºŸ¡„
    (ucs		. #x311B)	; ã„›
    ))
(define-char
  '((name		. "BOPOMOFO LETTER E")
    ...
    (total-strokes	 . 2)
    (->ideograph
     ((ideograph-daikanwa . 5)))
    (chinese-gb2312	. #x285C)	; ø»„‘‘
    (chinese-isoir165	. #x285C)	; ø»Œ¹¡
    (chinese-cns11643-1 . #x255E)	; ø»‘‰‘
    (chinese-big5	. #xA3AD)	; øºŸ¡…
    (ucs		. #x311C)	; ã„œ
    ))
(define-char
