(define-char
  '((name		. "IDEOGRAPHIC SPACE")
    ...
    (japanese-jisx0208-1990	. #x2121)	; ã€€
    (ucs			. #x3000)	; ã€€
    ))
(define-char
  '((name		. "IDEOGRAPHIC COMMA")
    ...
    (japanese-jisx0208-1990	. #x2122)	; ã€
    (ucs			. #x3001)	; ã€
    ))
(define-char
  '((name		. "IDEOGRAPHIC FULL STOP")
    ...
    (japanese-jisx0208-1990	. #x2123)	; ã€‚
    (ucs			. #x3002)	; ã€‚
    ))
(define-char
  '((name		. "DITTO MARK")
    ...
    (japanese-jisx0208-1990	. #x2137)	; ã€ƒ
    (ucs			. #x3003)	; ã€ƒ
    ))
(define-char
...
(define-char
  '((name		. "IDEOGRAPHIC ITERATION MARK")
    ...
    (japanese-jisx0208-1990	. #x2139)	; ã€…
...
(define-char
  '((name		. "IDEOGRAPHIC CLOSING MARK")
    ...
    (japanese-jisx0208-1990	. #x213A)	; ã€†
    (ucs			. #x3006)	; ã€†
    ))
(define-char
  '((name		. "IDEOGRAPHIC NUMBER ZERO")
    ...
    (japanese-jisx0208-1990	. #x213B)	; ã€‡
    (ucs			. #x3007)	; ã€‡
    ))
(define-char
  '((name		. "LEFT ANGLE BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2152)	; ã€ˆ
    (ucs			. #x3008)	; ã€ˆ
    ))
(define-char
  '((name		. "RIGHT ANGLE BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2153)	; ã€‰
    (ucs			. #x3009)	; ã€‰
    ))
(define-char
  '((name		. "LEFT DOUBLE ANGLE BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2154)	; ã€Š
    (ucs			. #x300A)	; ã€Š
    ))
(define-char
  '((name		. "RIGHT DOUBLE ANGLE BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2155)	; ã€‹
    (ucs			. #x300B)	; ã€‹
    ))
(define-char
  '((name		. "LEFT CORNER BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2156)	; ã€Œ
    (ucs			. #x300C)	; ã€Œ
    ))
(define-char
  '((name		. "RIGHT CORNER BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2157)	; ã€
    (ucs			. #x300D)	; ã€
    ))
(define-char
  '((name		. "LEFT WHITE CORNER BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2158)	; ã€Ž
    (ucs			. #x300E)	; ã€Ž
    ))
(define-char
  '((name		. "RIGHT WHITE CORNER BRACKET")
    ...
    (japanese-jisx0208-1990	. #x2159)	; ã€
    (ucs			. #x300F)	; ã€
    ))
(define-char
  '((name		. "LEFT BLACK LENTICULAR BRACKET")
    ...
    (japanese-jisx0208-1990	. #x215A)	; ã€
    (ucs			. #x3010)	; ã€
    ))
(define-char
  '((name		. "RIGHT BLACK LENTICULAR BRACKET")
    ...
    (japanese-jisx0208-1990	. #x215B)	; ã€‘
    (ucs			. #x3011)	; ã€‘
    ))
(define-char
  '((name		. "POSTAL MARK")
    ...
    (japanese-jisx0208-1990	. #x2229)	; ã€’
    (ucs			. #x3012)	; ã€’
    ))
(define-char
  '((name		. "GETA MARK")
    ...
    (japanese-jisx0208-1990	. #x222E)	; ã€“
    (ucs			. #x3013)	; ã€“
    ))
(define-char
  '((name		. "LEFT TORTOISE SHELL BRACKET")
    ...
    (japanese-jisx0208-1990	. #x214C)	; ã€”
    (ucs			. #x3014)	; ã€”
    ))
(define-char
  '((name		. "RIGHT TORTOISE SHELL BRACKET")
    ...
    (japanese-jisx0208-1990	. #x214D)	; ã€•
    (ucs			. #x3015)	; ã€•
    ))
(define-char
...
(define-char
  '((name		. "WAVE DASH")
    ...
    (japanese-jisx0208-1990	. #x2141)	; ã€œ
    (ucs			. #x301C)	; ã€œ
    ))
(define-char
