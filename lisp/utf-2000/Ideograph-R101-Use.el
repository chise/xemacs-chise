...
(define-char
  '((=>ucs		. #x752A)	; 甪
    ...
    (=jis-x0213-2-2000	. #x7133)	; &I-JX2-7133; [81-19]
...
(define-char
  '((=>ucs		. #x752F)	; 甯
    ...
    (=jis-x0213-1-2000	. #x7849)	; &I-JX1-7849; [88-41]
    (=big5		. #xDAAC)	; &I-B-DAAC;
...
(define-char
  '((morohashi-daikanwa	21720 0 0)
    ...
    (=ucs		. #x24C0E)	; 𤰎
    (=cns11643-7	. #x477D)	; &I-C7-477D; [39-93]
...
(define-char
  '((ideographic-radical . 101)	; ⽤
    ...
    (total-strokes	 . 21)
    (=ucs		. #x24C00)	; 𤰀
    (=cns11643-7	. #x5374)	; &I-C7-5374; [51-84]
    ))
(define-char
  '((ideographic-radical . 101)	; ⽤
