  ...
  '((<-denotational
    ...
    (->subsumptive
     ((=ucs@jis		  . #x623D)	; &AJ1-19383;
      ...
      (=adobe-japan1-5	  . 19383)	; &I-AJ1-19383;
      )
     ((=ucs@cns		  . #x623D)	; &C2-2671;
...
(define-char
  '((<-denotational
    ...
    (ideographic-strokes . 4)
    (total-strokes	 . 8)
    (=cns11643-4	. #x2656)	; &M-11713; [06-54]
...
(define-char
  '((<-denotational
    ...
    (ideographic-strokes . 4)
    (total-strokes	 . 8)
    (=>>ucs@ks		. #x623F)	; &G-KU+623F;
    (=>>ucs@cns		. #x623F)	; &G-KU+623F;
    (=big5		. #xA9D0)	; &G-KU+623F;
    (->subsumptive
     ((=ucs@ks		  . #x623F)	; &M-11714;
...
(define-char
  '((<-denotational
    ...
    (ideographic-strokes . 4)
    (total-strokes	 . 8)
    (=ucs@unicode	. #x6240)	; &GT-14778;
    (=gb2312		. #x4B79)	; &GT-14778; [43-89]
...
(define-char
  '((<-denotational
    ...
    (ideographic-strokes . 5)
    (total-strokes	 . 9)
    (=cns11643-4	. #x294D)	; &M-11721; [09-45]
...
(define-char
  '((ideographic-radical . 63)	; ⼾
    ...
    (->subsumptive
     ...
     ((=ucs@iso		  . #x22A38)	; &C6-3142;
      (=cns11643-6	  . #x3142)	; &C6-3142; [17-34]
      ))
    ))
(define-char
  '((ideographic-radical . 63)	; ⼾
...
(define-char
  '((ideographic-radical . 63)	; ⼾
    ...
    (=ucs		. #x39C2)	; 㧂
    (->subsumptive
     ((=cns11643-3	  . #x2C64)	; &M-11729; [12-68]
  ...
  '((ideographic-radical . 63)	; ⼾
    ...
    (->subsumptive
     ...
     ((hanyu-dazidian	  3 2263 3)
      (=ucs@unicode	  . #x6245)	; &HZK06-D459;
      (=iso-ir165	  . #x2C47)	; &HZK06-D459; [12-39]
...
(define-char
  '((<-denotational
    ...
    (ideographic-strokes . 8)
    (total-strokes	 . 12)
    (=ucs@unicode	. #x6249)	; &G0-6C69;
    (=gb2312		. #x6C69)	; &G0-6C69; [76-73]
    ))
(define-char
  '((<-denotational
     ((=ucs		  . #x6249)	; 扉
