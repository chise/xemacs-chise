...
(define-char
  '((ideographic-radical . 25)	; ⼘
	...
	(=ucs		    . #x2FF1)	; ⿱
      ...
      (=ucs@jis		  . #x535E)	; &MJ007868;
      (=ucs@ks		  . #x535E)	; &MJ007868;
      (=mj		  . 007868)	; &MJ007868;
...
(define-char
  '((ideographic-radical . 25)	; ⼘
    ...
    (total-strokes	 . 7)
    (=ucs		. #x209DA)	; 𠧚
    (=cns11643-5	. #x234F)	; &I-C5-234F; [03-47]
...
(define-char
  '((ideographic-radical . 25)	; ⼘
    ...
    (total-strokes	 . 8)
    (=ucs		. #x353D)	; 㔽
    (=cns11643-3	. #x2764)	; &I-C3-2764; [07-68]
...
(define-char
  '((<-denotational
    ...
    (=ucs@cns		. #x5368)	; &C4-3064;
    (=ucs@ks		. #x5368)	; &C4-3064;
...
(define-char
  '((ideographic-radical . 25)	; ⼘
    ...
    (total-strokes	 . 27)
    (=ucs		. #x20A0B)	; 𠨋
    (=cns11643-7	. #x634B)	; &I-C7-634B; [67-43]
