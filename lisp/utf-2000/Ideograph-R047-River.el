...
(define-char
  '((ideographic-radical . 47)	; ⼮
    ...
    (total-strokes	 . 6)
    (=ucs		. #x21FEA)	; 𡿪
    (=cns11643-5	. #x2254)	; &I-C5-2254; [02-52]
...
(define-char
  '((ideographic-radical . 47)	; ⼮
    ...
    (total-strokes	 . 6)
    (=ucs		. #x21FED)	; 𡿭
    (=cns11643-5	. #x2255)	; &I-C5-2255; [02-53]
...
(define-char
  '((<-denotational
    ...
    (ideographic-strokes . 3)
    (total-strokes	 . 6)
    (=>>ucs@unicode	. #x5DE1)	; &G-GT-10953;
    (=>>ucs@cns		. #x2F881)	; &G-GT-10953;
    (=>>jis-x0208	. #x3D64)	; &G-GT-10953; [29-68]
    (=>>jis-x0213-1	. #x3D64)	; &G-GT-10953; [29-68]
    (=>>gt		. 10953)	; &G-GT-10953;
    (->subsumptive
...
(define-char
  '((ideographic-radical . 47)	; ⼮
    ...
    (total-strokes	 . 7)
    (=ucs		. #x21FEF)	; 𡿯
    (=cns11643-4	. #x237E)	; &I-C4-237E; [03-94]
...
(define-char
  '((=>ucs		. #x21FF1)	; 𡿱
    ...
    (total-strokes	 . 8)
    (=cns11643-6	. #x2A7D)	; &M-08686; [10-93]
...
(define-char
  '((=>ucs		. #x21FF8)	; 𡿸
    ...
    (ideographic-strokes . 6)
    (total-strokes	 . 9)
    (=cns11643-6	. #x3054)	; &M-08689; [16-52]
...
(define-char
  '((<-denotational
    ...
    (ideographic-strokes . 8)
    (total-strokes	 . 11)
    (=ucs@unicode	. #x5DE2)	; &M-08696;
    (=gb2312		. #x3332)	; &M-08696; [19-18]
...
(define-char
  '((ideographic-radical . 47)	; ⼮
	...
	(=hanziku-3	    . #xE060)	; &HZK03-E060;
     ...
     ((=cns11643-6	  . #x5C48)	; &C6-5C48; [60-40]
      ))
    ))
(define-char
  '((ideographic-radical . 47)	; ⼮
...
(define-char
  '((<-denotational
    ...
    (=jis-x0212		. #x3B7E)	; &AJ1-17586; [27-94]
    (=jis-x0213-2	. #x286D)	; &I-JX2-286D; [08-77]
    (=daikanwa		. 08702)	; &I-M-08702;
    (=adobe-japan1-5	. 17586)	; &I-AJ1-17586;
    ))
(define-char
  '((<-denotational
     ((=ucs		  . #x5DE4)	; 巤
    ...
    (ideographic-strokes . 12)
    (total-strokes	 . 15)
    (=cns11643-3	. #x4B6C)	; &C3-4B6C; [43-76]
    ))
(define-char
  '((<-denotational
     ((=ucs		  . #x5DE4)	; 巤
