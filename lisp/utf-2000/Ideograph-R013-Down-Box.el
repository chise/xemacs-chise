  ...
  '((<-denotational
    ...
    (->subsumptive
     ((=decomposition@cid
      ...
      (=ucs@unicode	  . #x56D8)	; 囘󠄀
      (=jis-x0208	  . #x5145)	; 囘󠄀 [49-37]
...
(define-char
  '((<-denotational
    ...
    (=>>ucs@unicode	. #x518D)	; 再󠄁
    (=ucs@unicode	. #x518D)	; 再󠄁
    (=jis-x0208		. #x3A46)	; 再󠄁 [26-38]
...
(define-char
  '((<-denotational
    ...
    (=>>ucs@unicode	. #x5190)	; 冐󠄀
    (=ucs@unicode	. #x5190)	; 冐󠄀
    (=jis-x0208		. #x666E)	; 冐󠄀 [70-78]
...
(define-char
  '((<-denotational
    ...
    (=ucs@unicode	. #x5191)	; 冑󠄀
    (=jis-x0208@1978/4-pr . #x5149)	; 冑󠄀 [49-41]
    (=jis-x0208@1983	. #x5149)	; 冑󠄀 [49-41]
  ...
  '((<-denotational
    ...
    (->subsumptive
     ((=decomposition@cid
      ...
      (=ucs@unicode	  . #x5193)	; 冓󠄀
      (=jis-x0208@1990	  . #x514A)	; 冓󠄀 [49-42]
...
(define-char
  '((<-denotational
    ...
    (=ucs@unicode	. #x5195)	; 冕󠄁
    (=gb2312		. #x4361)	; 冕󠄁 [35-65]
