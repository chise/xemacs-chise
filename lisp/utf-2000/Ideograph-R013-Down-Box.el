...
(define-char
  '((<-denotational
    ...
    (=daikanwa/ho	.  0037)	; &AJ1-04222;
    (=shinjigen		.  0512)	; &AJ1-04222;
    ))
(define-char
  '((ideographic-radical . 13)	; ⼌
    (ideographic-strokes . 3)
...
(define-char
  '((<-denotational
    ...
    (=jis-x0212		. #x3273)	; &AJ1-21183; [18-83]
    (=cns11643-4	. #x2236)	; &I-C4-2236; [02-22]
    (=adobe-japan1-6	. 21183)	; &I-AJ1-21183;
...
(define-char
  '((<-denotational
    ...
    (=>>ucs@unicode	. #x518D)	; &AJ1-02102;
    (=ucs@unicode	. #x518D)	; &AJ1-02102;
    (=jis-x0208		. #x3A46)	; &AJ1-02102; [26-38]
...
(define-char
  '((<-denotational
    ...
    (=>>ucs@jis		. #x518F)	; &G-GT-02006;
    (=>>ucs@cns		. #x518F)	; &G-GT-02006;
    (=>>jis-x0208	. #x5148)	; &G-GT-02006; [49-40]
    (=>>jis-x0213-1	. #x5148)	; &G-GT-02006; [49-40]
    (=>>adobe-japan1-0	. 04223)	; &G-GT-02006;
    (=>>gt		. 02006)	; &G-GT-02006;
    (=>>gt-k		. 02683)	; &G-GT-02006;
    (=>>daikanwa	. 01528)	; &G-GT-02006;
    (->subsumptive
     ((=decomposition@cid
       ((=ucs		    . #x518F)	; 冏
	)
...
(define-char
  '((<-denotational
    ...
    (=ucs@unicode	. #x5190)	; &AJ1-06235;
    (=jis-x0208		. #x666E)	; &AJ1-06235; [70-78]
    (=jis-x0213-1	. #x666E)	; &I-JX1-666E; [70-78]
    (=adobe-japan1-0	. 06235)	; &I-AJ1-06235;
    (=gt		. 02014)	; &I-GT-02014;
...
(define-char
  '((<-denotational
    ...
    (=hanyo-denshi/ks	. 018290)	; &HD-KS-018290;
    (=hanyo-denshi/ks/mf . #x0725)	; &HD-KS-018290;
    (=gt		. 02023)	; &I-GT-02023;
  ...
  '((<-denotational
    ...
    (->subsumptive
     ((=decomposition@cid
      ...
      (=jis-x0208@1990	  . #x514A)	; &AJ1-04225; [49-42]
     ...
     ((=decomposition@cid
      ...
      (=jis-x0208@1978	  . #x514A)	; &AJ1-13521; [49-42]
...
(define-char
  '((<-denotational
    ...
    (=>>>ucs@ks		. #x5195)	; &g2-KU+5195;
    (=>>>ucs@cns	. #x2F8D3)	; &g2-KU+5195;
    (->subsumptive
     ((ideographic-radical . 13)	; ⼌
      (ideographic-strokes . 9)
      (=decomposition@cid
...
(define-char
  '((<-denotational
    ...
    (=>>jis-x0213-1	. #x3A47)	; &G-J0-3A47; [26-39]
    (=>>adobe-japan1-0	. 02103)	; &G-J0-3A47;
    (=>>hanyo-denshi/ja . #x3A47)	; &G-J0-3A47; [26-39]
    (=>>daikanwa	. 14301)	; &G-J0-3A47;
    (->subsumptive
     ((=>ucs*		  . #x6700)	; 最
      (=ucs		  . #x2F8D4)	; 最
      (->subsumptive
