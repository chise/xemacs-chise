...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=jis-x0213-1-2000	. #x2E24)	; &I-JX1-2E24; [14-04]
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=shinjigen@1ed	.  0033)	; 个
    (=shinjigen@rev	.  0033)	; 个
    (=cbeta		. 00286)	; &I-CB00286;
    (mojikyo		. 000070)	; &MCS-60000046;
    (<-simplified@CN
     ((=ucs		  . #x500B)	; 個
      (=gb12345		  . #x3876)	; 個 [24-86]
      ))
    ))
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=jis-x0213-2-2000	. #x2126)	; &I-JX2-2126; [01-06]
    (=big5		. #xA458)	; &I-B-A458;
    (=gt		. 00104)	; &I-GT-00104;
    (=gt-k		. 00359)	; &I-GT-K00359;
    (=gt-pj-2		. #x3056)	; &I-GT-00104; [16-54]
    (=daikanwa		. 00071)	; &I-M-00071;
    (=shinjigen@1ed	.  0032)	; 丫
    (=shinjigen@rev	.  0032)	; 丫
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=jis-x0213-2-2000	. #x702E)	; &I-JX2-702E; [80-14]
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=shinjigen@1ed	.  0034)	; 中
    (=shinjigen@rev	.  0034)	; 中
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=jis-x0213-2-2000	. #x2127)	; &I-JX2-2127; [01-07]
    (=big5		. #xC950)	; &I-B-C950;
    (=gt		. 00108)	; &I-GT-00108;
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=jis-x0213-1-2000	. #x2E25)	; &I-JX1-2E25; [14-05]
  ...
  '((ideographic-radical . 2)	; ⼁
    ...
    (->subsumptive
     ((=gb2312		  . #x3761)	; &GT-00110; [23-65]
      ...
      (=shinjigen@1ed	  .  0035)	; &GT-00110;
      (=shinjigen@rev	  .  0035)	; &GT-00110;
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=shinjigen@1ed	.  0036)	; 丱
    (=shinjigen@rev	.  0036)	; 丱
...
(define-char
  '((ideographic-radical@ucs . 2)	; ⼁
    ...
    (->subsumptive
     ...
     ((=cns11643-6	  . #x225F)	; &CDP-87E5; [02-63]
      (=big5-cdp	  . #x87E5)	; &I-CDP-87E5;
      (=ucs@iso		  . #x20064)	; &CDP-87E5;
      ))
    ))
(define-char
  '((ideographic-radical . 2)	; ⼁
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=shinjigen@1ed	.  0038)	; 串
    (=shinjigen@rev	.  0038)	; 串
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (total-strokes	 . 8)
    (=ucs		. #x2006B)	; 𠁫
    (=cns11643-5	. #x2521)	; &I-C5-2521; [05-01]
    ))
(define-char
  '((ideographic-radical . 2)	; ⼁
    (ideographic-strokes . 7)
...
(define-char
  '((ideographic-radical . 2)	; ⼁
	...
	(=ucs		    . #x2FF1)	; ⿱
      ...
      (=jis-x0212	  . #x302E)	; &GT-00124; [16-14]
      (=cns11643-4	  . #x2B5E)	; &I-C4-2B5E; [11-62]
      (=gt		  . 00124)	; &I-GT-00124;
      (=gt-pj-2		  . #x3063)	; &I-GT-00124; [16-67]
      (=daikanwa	  . 00087)	; &I-M-00087;
      (=ucs@unicode	  . #x4E35)	; &GT-00124;
...
(define-char
  '((ideographic-radical . 2)	; ⼁
    ...
    (=ucs		. #x20070)	; 𠁰
    (=cns11643-6	. #x3525)	; &I-C6-3525; [21-05]
