...
(when (featurep 'utf-2000)
  ...
  (setq coded-charset-entity-reference-alist
	'(((=mj			. isolated)	 "I-MJ" 6 d)
	  ...
	  (=>>>hanyo-denshi/jt		     "G-HD-JT-" 4 X)
	  (=>>>gt				"G-GT-" 5 d)
	  (=>>adobe-japan1		      "g1-AJ1-" 5 d)
	  (=>>jis-x0208			       "g1-J0-" 4 X)
	  (=>>jis-x0213-1@2000		      "g1-JX1-" 4 X)
	  (=>>jis-x0213-2		      "g1-JX2-" 4 X)
	  (=>>jis-x0213-1@2004		      "g1-JX3-" 4 X)
	  (=>>hanyo-denshi/ft		    "g1-HD-FT-" 4 X)
	  (=>>hanyo-denshi/ia		    "g1-HD-IA-" 4 X)
	  (=>>hanyo-denshi/ib		    "g1-HD-IB-" 4 X)
	  (=>>hanyo-denshi/jt		    "g1-HD-JT-" 4 X)
	  (=>>hanyo-denshi/ks		    "g1-HD-KS-" 4 X)
	  (=>>gt			       "g1-GT-" 5 d)
	  (=>>jis-x0208@1978		      "g1-J78-" 4 X)
	  (=>>cns11643-4		       "g1-C4-" 4 X)
	  (=>>big5-cdp			      "g1-CDP-" 4 X)
	  (=>>gt-k			      "g1-GT-K" 5 d)
	  (=>>ruimoku-v6		     "g1-RUI6-" 4 X)
	  (=>>cbeta				"g1-CB" 5 d)
	  (=+>jis-x0208				"o-J0-" 4 X)
	  ...
	  (=+>ucs@ks				"o-KU+" 4 X)
	  (=>>ucs@iso			       "g1-IU+" 4 X)
	  (=>>ucs@unicode		       "g1-UU+" 4 X)
	  (=>>ucs@jis			       "g1-JU+" 4 X)
	  (=>>ucs@ks			       "g1-KU+" 4 X)
	  (=>>ucs@cns			       "g1-CU+" 4 X)
	  (=>>ucs@jis/2004		     "g1-J04U+" 4 X)
	  (=>>ucs@jis/2000		     "g1-J00U+" 4 X)
	  (=>>ucs@jis/1990		     "g1-J90U+" 4 X)
	  (=>>ucs@JP			      "g1-dJU+" 4 X)
	  ( =ucs@iso				   "U-" 8 X)
	  ( =ucs@unicode			  "UU+" 4 X)
	  ( =ucs@unicode			  "UU-" 8 X)
	  ...
	  (===cns11643-6			"R-C6-" 4 X)
	  (===cns11643-7			"R-C7-" 4 X)
	  (==ucs@JP/hanazono		    "G-hanaJU+" 4 X)
	  (==ruimoku-v6			      "G-RUI6-" 4 X)
	  ( china3-jef				 "JC3-" 4 X)
	  (==jef-china3			       "G-JC3-" 4 X)
	  (===jef-china3		       "R-JC3-" 4 X)
	  ( =big5				   "B-" 4 X)
	  ( =big5				  "C0-" 4 X)
	  ( =big5-eten				  "BE-" 4 X)
	  (=>>daikanwa			       "g1-M-"	5 d)
	  (=>>daikanwa/+p		       "g1-M-p" 5 d)
	  (=>daikanwa				 "A-M-" 5 d)
	  ...
	  (==shinjigen@rev		      "G-SJG2-" 4 d)
	  (==shinjigen@1ed		      "G-SJG1-" 4 d)
	  (=>>>ucs@iso				"G-IU+" 4 X)
	  (=>>>ucs@iso			       "GI-IU+" 4 X)
	  (=>>>ucs@unicode			"G-UU+" 4 X)
